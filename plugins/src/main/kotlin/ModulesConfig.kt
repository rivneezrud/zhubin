...
object ModulesConfig {
    ...
    val analyticsConfig: AnalyticsConfig = run {
        // Zhubin: Completely disable analytics and crash reporting (Posthog + Sentry)
        println("Zhubin: Analytics and crash reporting completely disabled (no Posthog/Sentry)")
